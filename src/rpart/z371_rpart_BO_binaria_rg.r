...
ksemilla_azar  <- c(220789,220793)  #Mas de una semilla cambia el  1-Repeated
...
{
  divi  <- rep( 2, qfolds )  # generalmente  c(1, 1, 1, 1, 1 )  cinco unos
...
dataset  <- fread("./datasets/competencia1_2022_FE_test1.csv")   #donde entreno
...
dir.create( "./exp/HT3710/", showWarnings = FALSE )
setwd("./exp/HT3710/")   #Establezco el Working Directory DEL EXPERIMENTO
